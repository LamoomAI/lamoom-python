...
def test_openai_pricing(lamoom_client: Lamoom):
    ...
    result_4o = lamoom_client.call(prompt.id, context, "openai/o4-mini", test_data={'ideal_answer': "There are eight", 'behavior_name': "gemini"}, stream_function=stream_function, check_connection=stream_check_connection, params={"stream": True}, stream_params={"validate": True, "end": "", "flush": True})
